...
public class QuizAdapterFactory extends AdapterFactoryImpl
{
  ...
  protected QuizSwitch<Adapter> modelSwitch =
    ...
    {
      @Override
      public Adapter caseQuizGame(QuizGame object)
      {
        return createQuizGameAdapter();
      }
      @Override
  ...
  /**
   * Creates a new adapter for an object of class '{@link v1.quiz.quiz.QuizGame <em>Game</em>}'.
   * <!-- begin-user-doc -->
   ...
   * @generated
   */
  public Adapter createQuizGameAdapter()
  {
    return null;
  }

  /**
   * Creates a new adapter for an object of class '{@link v1.quiz.quiz.Quiz <em>Quiz</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link v1.quiz.quiz.Choice <em>Choice</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
