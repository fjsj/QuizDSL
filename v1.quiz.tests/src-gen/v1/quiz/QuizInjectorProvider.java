...
public class QuizInjectorProvider implements IInjectorProvider, IRegistryConfigurator {
	...
	public Injector getInjector() {
		if (injector == null) {
			this.injector = new QuizStandaloneSetup().createInjectorAndDoEMFRegistration();
		}
		return injector;
	}
